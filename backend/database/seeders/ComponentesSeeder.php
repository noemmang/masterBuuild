...
class ComponentesSeeder extends Seeder
{
    ...
    protected function seedRefrigeracionesLiquidas(): void
    {
        ...
        $this->crearRefrigeracionLiquida(
            comp: ['nombre' => 'Asus ROG Strix SLC IV 360 ARGB LCD', 'marca' => 'ASUS', 'modelo' => 'ROG STRIX LC IV 360 ARGB LCD', 'descripcion' => 'AIO 360 mm con bomba Asetek de 7ª generación y pantalla IPS a color de 2.1" en el cabezal para monitorización o personalización. Tres ventiladores ROG Strix AF-12S ARGB de 120 mm con soporte 0 RPM. Compatible con AM4/AM5 e Intel LGA1851/1700/1200/115x.', 'imagen_url' => 'https://dlcdnwebimgs.asus.com/gain/D7F9BD01-3E5A-4FF8-A1F3-59864EDCCF45'],
