...
class ComponentesSeeder extends Seeder
{
    ...
    protected function seedGabinetes(): void
    {
        ...
        /// ATX  
        $this->crearGabinete(
            comp: ['nombre' => 'Cooler Master NR200P', 'marca' => 'Cooler Master', 'modelo' => 'SL600M-KGNN-S00', 'descripcion' => 'Caja ATX Mid Tower con estructura convencional, panel lateral TG y óptimo flujo de aire vertical. Soporta GPU hasta 410 mm y radiadores de 360 mm.', 'imagen_url' => 'https://manuals.plus/wp-content/uploads/2022/08/COOLER-MASTER-NR200P-Mini-ITX-PC-Case-features.jpg'],
            gab: ['tipo_id' => $mid->id, 'estructura_id' => $conv->id, 'ff' => [$atx, $eatx, $matx, $itx], 'psu_tipos' => [$pATX], 'gpu_max' => 410, 'cooler_max' => 185, 'psu_max' => 220, 'bahias35' => 2, 'bahias25' => 2, 'vent_front' => 3, 'vent_sup' => 2, 'vent_tras' => 1, 'vent_incl' => 0, 'tam_front' => 120, 'tam_sup' => 120, 'tam_tras' => 120, 'sop_rad' => [120, 240, 280, 360], 'usb_front' => ['2xUSB3', '1xUSB-C'], 'vert_pcie' => true, 'panel' => 'Tempered Glass', 'ancho' => 230, 'alto' => 520, 'prof' => 480],
            historial: [
